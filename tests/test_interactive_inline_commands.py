...
def test_inline_explain_command_triggers_file_explain(monkeypatch):
    called = {}
...
def test_inline_refactor_command_triggers_file_refactor(monkeypatch):
    called = {}
    target = Path("/tmp/fake/views.py")
...
def test_inline_file_context_command_sets_context(monkeypatch):
    target = Path("/tmp/fake/views.py")
    content = "def x():\n    return 1\n"
...
def test_inline_at_file_reference_sets_context_and_rewrites_question(monkeypatch):
    target = Path("/tmp/fake/views.py")
    content = "def x():\n    return 1\n"
...
def test_inline_at_file_reference_sets_context_without_rewritten_question(monkeypatch):
    target = Path("/tmp/fake/views.py")
    content = "def x():\n    return 1\n"
